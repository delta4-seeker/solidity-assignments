...
contract WolfNFTContract is Ownable, ERC721("wolfNFT" , "WLF"){
 ...
 function addUserToWhitelist(address _newAddress) public onlyOwner {

     whitelistAddress[_newAddress] = true ; 

 }

 modifier isWhitelisted(address _recipient){
     require(whitelistAddress[_recipient] , "The recipient is not Whitelisted." );
     _;
 }
...
function mintToken(address recipient) onlyOwner isWhitelisted(recipient) public{
